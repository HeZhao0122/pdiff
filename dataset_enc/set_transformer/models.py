...
class SetTransformer(nn.Module):
    def __init__(self, in_dim, num_inds, hidden_dim, num_heads):
        super(SetTransformer, self).__init__()
        # enconfig=config.params.encoder
        # deconfig=config.params.decoder
        self.enc = encoder(in_dim, num_inds, hidden_dim, num_heads)
        self.dec = decoder(1, in_dim, hidden_dim, num_heads)
